...
> **Status:** OpenShell sandbox validated locally (E2E with Opus 4.6 — investigate
> through PR creation). Infrastructure scaffolding ready (manifests, Containerfile,
> policies). Cluster deployment pending.
>
